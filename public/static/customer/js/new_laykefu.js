...
;!function(win){
    ...
    var Laykefu = function(){
        ...
        var tpl  = "<div style= 'width:70%;height:90%;max-width:" + config.width + ";min-width:360px;height:"+ config.height+";' class='tpl' id='laykefu'>";
        tpl +=      '<div class="small-chat-box fadeInRight animated">';
        tpl +=          '<div class="heading" draggable="true">';;
        tpl +=              '<small class="chat-date pull-right laykefu-close" id="hidden-laykefu" title="关闭">';
        // tpl +=              '关闭';
        tpl +=              '</small>';
        ...
        // $("#laykefu-max").click(function(){
        //     $("#laykefu").css('display','none');
        //     $(".laykefu-min").css('display','block');
        //     window.open("http://kefu.gg/index/index/new_index.html","_blank");
        // })
    };
    ...
    Laykefu.prototype.init = function(options){
        options.uid = options.uid || '',//客户id
            ...
            options.width = options.width || '640px', //窗口宽度
            config = options;
        register();
        event();
    }
